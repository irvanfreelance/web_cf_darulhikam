            ...
            <div className="grid gap-4 mb-8">
              <div className="flex gap-4 items-start p-4 bg-white rounded-xl border border-[#e2e8f0]">
                ...
                <div>
                  ...
                  <div className="text-[13.5px] text-[#94a3b8] leading-relaxed">{config?.address || "Jl. Kebaikan Bangsa No. 99, Gedung Amal Lt. 2, Jakarta Selatan"}</div>
                </div>
              </div>
              <div className="flex gap-4 items-start p-4 bg-white rounded-xl border border-[#e2e8f0]">
                <div className="w-11 h-11 bg-[#e8f0fb] rounded-xl flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <div className="text-[13.5px] text-[#94a3b8] leading-relaxed">{config?.whatsapp_number || "0800-1-ZAKAT"}</div>
                </div>
              </div>
              <div className="flex gap-4 items-start p-4 bg-white rounded-xl border border-[#e2e8f0]">
                <div className="w-11 h-11 bg-[#e8f0fb] rounded-xl flex items-center justify-center shrink-0">
