...
--
-- Database: neondb
-- Generation Time: 2026-07-20 09:58:30.7450
-- -------------------------------------------------------------


DROP VIEW IF EXISTS "public"."v_article_seo";


DROP VIEW IF EXISTS "public"."v_published_articles";
...
DROP TABLE IF EXISTS "public"."web_articles";
-- Sequence and defined type
CREATE SEQUENCE IF NOT EXISTS web_articles_id_seq;

-- Table Definition
CREATE TABLE "public"."web_articles" (
    "id" int8 NOT NULL DEFAULT nextval('web_articles_id_seq'::regclass),
    "slug" varchar(220) NOT NULL,
    "title" varchar(70) NOT NULL,
    "title_long" varchar(300),
    "excerpt" varchar(160) NOT NULL,
    "body" text NOT NULL,
    "status" varchar(20) NOT NULL DEFAULT 'draft'::character varying CHECK ((status)::text = ANY ((ARRAY['draft'::character varying, 'published'::character varying, 'archived'::character varying])::text[])),
    "featured_image_url" text,
    "featured_image_alt" varchar(300),
    "featured_image_caption" varchar(500),
    "featured_image_width" int2,
    "featured_image_height" int2,
    "seo_title" varchar(70),
    "seo_description" varchar(160),
    "og_image_url" text,
    "og_image_alt" varchar(300),
    "canonical_url" text,
    "robots_directive" varchar(30) NOT NULL DEFAULT 'index,follow'::character varying CHECK ((robots_directive)::text = ANY ((ARRAY['index,follow'::character varying, 'noindex,follow'::character varying, 'index,nofollow'::character varying, 'noindex,nofollow'::character varying])::text[])),
    "schema_org_json" jsonb,
    "twitter_title" varchar(70),
    "twitter_description" varchar(200),
    "twitter_card_type" varchar(25) NOT NULL DEFAULT 'summary_large_image'::character varying CHECK ((twitter_card_type)::text = ANY ((ARRAY['summary'::character varying, 'summary_large_image'::character varying])::text[])),
    "locale" varchar(10) NOT NULL DEFAULT 'id'::character varying,
    "program_id" int8,
...
DROP TABLE IF EXISTS "public"."web_article_tags";
-- Table Definition
...
DROP TABLE IF EXISTS "public"."web_tags";
-- Sequence and defined type
CREATE SEQUENCE IF NOT EXISTS web_tags_id_seq;

-- Table Definition
CREATE TABLE "public"."web_tags" (
    "id" int8 NOT NULL DEFAULT nextval('web_tags_id_seq'::regclass),
...
DROP TABLE IF EXISTS "public"."web_testimonials";
-- Sequence and defined type
CREATE SEQUENCE IF NOT EXISTS web_testimonials_id_seq;

-- Table Definition
CREATE TABLE "public"."web_testimonials" (
    "id" int8 NOT NULL DEFAULT nextval('web_testimonials_id_seq'::regclass),
    "person_name" varchar(150) NOT NULL,
    "person_role" varchar(150) NOT NULL,
    "person_type" varchar(20) NOT NULL CHECK ((person_type)::text = ANY ((ARRAY['muzakki'::character varying, 'mustahiq'::character varying])::text[])),
    "initials" bpchar(3) NOT NULL,
    "quote" text NOT NULL,
    "avatar_url" text,
    "program_id" int8,
...
DROP TABLE IF EXISTS "public"."web_impact_metrics";
-- Sequence and defined type
CREATE SEQUENCE IF NOT EXISTS web_impact_metrics_id_seq;

-- Table Definition
CREATE TABLE "public"."web_impact_metrics" (
    "id" int8 NOT NULL DEFAULT nextval('web_impact_metrics_id_seq'::regclass),
...
DROP TABLE IF EXISTS "public"."web_financial_reports";
-- Sequence and defined type
CREATE SEQUENCE IF NOT EXISTS web_financial_reports_id_seq;

-- Table Definition
CREATE TABLE "public"."web_financial_reports" (
    "id" int8 NOT NULL DEFAULT nextval('web_financial_reports_id_seq'::regclass),
    "title" varchar(250) NOT NULL,
    "report_type" varchar(30) NOT NULL CHECK ((report_type)::text = ANY ((ARRAY['annual'::character varying, 'quarterly'::character varying, 'monthly'::character varying, 'special_audit'::character varying])::text[])),
    "period_label" varchar(50) NOT NULL,
    "period_year" int2 NOT NULL,
    "period_quarter" int2 CHECK (period_quarter = ANY (ARRAY[1, 2, 3, 4])),
    "audit_status" varchar(40) NOT NULL DEFAULT 'unaudited'::character varying CHECK ((audit_status)::text = ANY ((ARRAY['unaudited'::character varying, 'internally_reviewed'::character varying, 'kap_audited'::character varying])::text[])),
...
DROP TABLE IF EXISTS "public"."web_faqs";
-- Sequence and defined type
CREATE SEQUENCE IF NOT EXISTS web_faqs_id_seq;

-- Table Definition
CREATE TABLE "public"."web_faqs" (
    "id" int8 NOT NULL DEFAULT nextval('web_faqs_id_seq'::regclass),
    "question" text NOT NULL,
    "answer" text NOT NULL,
    "category" varchar(60) DEFAULT 'general'::character varying CHECK ((category)::text = ANY ((ARRAY['general'::character varying, 'donation'::character varying, 'zakat'::character varying, 'program'::character varying, 'partnership'::character varying, 'technical'::character varying])::text[])),
    "is_active" bool NOT NULL DEFAULT true,
    "display_order" int2 NOT NULL DEFAULT 0,
    "created_by" int8,
    "updated_by" int8,
...
DROP TABLE IF EXISTS "public"."web_fund_allocations";
-- Sequence and defined type
CREATE SEQUENCE IF NOT EXISTS web_fund_allocations_id_seq;

-- Table Definition
CREATE TABLE "public"."web_fund_allocations" (
    "id" int8 NOT NULL DEFAULT nextval('web_fund_allocations_id_seq'::regclass),
    "program_id" int8 NOT NULL,
    "period_year" int2 NOT NULL,
    "period_month" int2 NOT NULL CHECK ((period_month >= 1) AND (period_month <= 12)),
    "allocated_amount" numeric(15,2) NOT NULL CHECK (allocated_amount >= (0)::numeric),
    "disbursed_amount" numeric(15,2) NOT NULL DEFAULT 0 CHECK (disbursed_amount >= (0)::numeric),
    "beneficiary_count" int4 NOT NULL DEFAULT 0,
    "notes" text,
    "created_by" int8,
    "created_at" timestamptz NOT NULL DEFAULT now(),
    "updated_at" timestamptz NOT NULL DEFAULT now(),
...
DROP TABLE IF EXISTS "public"."web_cms_audit_log";
-- Sequence and defined type
CREATE SEQUENCE IF NOT EXISTS web_cms_audit_log_id_seq;

-- Table Definition
CREATE TABLE "public"."web_cms_audit_log" (
    "id" int8 NOT NULL DEFAULT nextval('web_cms_audit_log_id_seq'::regclass),
    "user_id" int8 NOT NULL,
    "action" varchar(30) NOT NULL CHECK ((action)::text = ANY ((ARRAY['create'::character varying, 'update'::character varying, 'delete'::character varying, 'publish'::character varying, 'unpublish'::character varying, 'verify_donation'::character varying])::text[])),
...
DROP TABLE IF EXISTS "public"."web_partners";
-- Sequence and defined type
CREATE SEQUENCE IF NOT EXISTS web_partners_id_seq;

-- Table Definition
CREATE TABLE "public"."web_partners" (
    "id" int8 NOT NULL DEFAULT nextval('web_partners_id_seq'::regclass),
    "name" varchar(200) NOT NULL,
    "logo_url" text,
    "website_url" text,
    "partner_type" varchar(50) CHECK ((partner_type)::text = ANY ((ARRAY['corporate'::character varying, 'government'::character varying, 'ngo'::character varying, 'academic'::character varying, 'media'::character varying, 'other'::character varying])::text[])),
    "is_active" bool NOT NULL DEFAULT true,
    "display_order" int2 NOT NULL DEFAULT 0,
    "created_at" timestamptz NOT NULL DEFAULT now(),
    "updated_at" timestamptz NOT NULL DEFAULT now(),
...
DROP TABLE IF EXISTS "public"."web_team_members";
-- Sequence and defined type
CREATE SEQUENCE IF NOT EXISTS web_team_members_id_seq;

-- Table Definition
CREATE TABLE "public"."web_team_members" (
    "id" int8 NOT NULL DEFAULT nextval('web_team_members_id_seq'::regclass),
    "name" varchar(150) NOT NULL,
    ...
    "avatar_url" text,
    "bio" text,
    "accent_color" varchar(10) DEFAULT '#3268C3'::character varying,
    "is_active" bool NOT NULL DEFAULT true,
    "display_order" int2 NOT NULL DEFAULT 0,
    "created_at" timestamptz NOT NULL DEFAULT now(),
    "updated_at" timestamptz NOT NULL DEFAULT now(),
...
DROP TABLE IF EXISTS "public"."web_bank_accounts";
-- Sequence and defined type
CREATE SEQUENCE IF NOT EXISTS web_bank_accounts_id_seq;

-- Table Definition
CREATE TABLE "public"."web_bank_accounts" (
    "id" int8 NOT NULL DEFAULT nextval('web_bank_accounts_id_seq'::regclass),
...
DROP TABLE IF EXISTS "public"."web_article_categories";
-- Sequence and defined type
CREATE SEQUENCE IF NOT EXISTS web_article_categories_id_seq;

-- Table Definition
CREATE TABLE "public"."web_article_categories" (
    "id" int8 NOT NULL DEFAULT nextval('web_article_categories_id_seq'::regclass),
    "name" varchar(100) NOT NULL,
...
INSERT INTO "public"."web_articles" ("id", "slug", "title", "title_long", "excerpt", "body", "status", "featured_image_url", "featured_image_alt", "featured_image_caption", "featured_image_width", "featured_image_height", "seo_title", "seo_description", "og_image_url", "og_image_alt", "canonical_url", "robots_directive", "schema_org_json", "twitter_title", "twitter_description", "twitter_card_type", "locale", "program_id", "author_id", "published_at", "is_featured", "view_count", "read_time_min", "created_at", "updated_at", "deleted_at", "category_id") VALUES
(1, 'distribusi-air-bersih-ntt-2025', 'Distribusi Air Bersih untuk 1.200 Warga di NTT', 'Distribusi Air Bersih untuk 1.200 Warga Terdampak Kekeringan di NTT', 'Tim relawan LAZ mendistribusikan 15.000 liter air bersih ke 8 desa terpencil di Kabupaten Kupang, NTT.', '<h2>Krisis Air di Kabupaten Kupang</h2>
...
<p>LAZ Darul Hikam berencana mendistribusikan air tahap kedua dan mensurvei kebutuhan sumur bor permanen di 3 desa paling kritis. Dukung program ini dengan berdonasi pada kanal Tanggap Bencana.</p>', 'published', 'https://images.pexels.com/photos/2962405/pexels-photo-2962405.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750', 'Warga antri mengambil air dari tanki distribusi LAZ Darul Hikam di NTT', 'Distribusi air bersih LAZ Darul Hikam di Kabupaten Kupang, NTT — Juli 2025', 1200, 630, NULL, NULL, NULL, 'Distribusi air bersih LAZ Darul Hikam di NTT untuk warga terdampak kekeringan', NULL, 'index,follow', NULL, NULL, NULL, 'summary_large_image', 'id', 3, 4, '2025-07-12 01:00:00+00', 't', 0, 5, '2026-07-19 15:37:33.049361+00', '2026-07-19 22:31:49.902212+00', NULL, 1),
(2, 'masjid-at-taqwa-kalteng-progress', 'Masjid At-Taqwa Kalimantan Tengah Capai 70%', 'Pembangunan Masjid At-Taqwa di Kalimantan Tengah Capai 70%', 'Progres konstruksi Masjid At-Taqwa di Kalimantan Tengah berjalan lancar dan dipastikan selesai Agustus 2025.', '<h2>Update Progres Pembangunan</h2>
...
<p>Program ini didukung lebih dari <strong>340 wakif</strong> dari seluruh Indonesia. Jazakumullahu khairan kepada seluruh donatur. Wakaf masih terbuka hingga target terpenuhi.</p>', 'published', 'https://images.pexels.com/photos/2098427/pexels-photo-2098427.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750', 'Tampak depan Masjid At-Taqwa Kalimantan Tengah yang sedang dibangun', 'Masjid At-Taqwa, Desa Tewah, Kabupaten Gunung Mas — progres Juli 2025', 1200, 630, NULL, NULL, NULL, 'Progres pembangunan Masjid At-Taqwa Kalimantan Tengah LAZ Darul Hikam', NULL, 'index,follow', NULL, NULL, NULL, 'summary_large_image', 'id', 5, 4, '2025-07-05 02:00:00+00', 'f', 0, 4, '2026-07-19 15:37:33.049361+00', '2026-07-19 22:31:49.902212+00', NULL, 1),
(3, 'beasiswa-2025-2026-penerima', '48 Siswa Dhuafa Terima Beasiswa Penuh 2025/2026', '48 Siswa Dhuafa Berprestasi Terima Beasiswa Penuh Tahun Ajaran 2025/2026', 'LAZ Darul Hikam menetapkan 48 siswa dhuafa berprestasi sebagai penerima beasiswa penuh 2025/2026, tersebar di 12 kota.', '<h2>Seleksi Ketat, Amanah Besar</h2>
...
<p>Program Beasiswa Generasi Rabbani telah mencetak lebih dari <strong>420 alumni</strong> sejak 2014. Dukung generasi berikutnya dengan berinfaq melalui program beasiswa kami.</p>', 'published', 'https://images.pexels.com/photos/7092613/pexels-photo-7092613.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750', 'Para penerima beasiswa LAZ Darul Hikam 2025 berfoto bersama di Bandung', 'Pengumuman resmi penerima Beasiswa Generasi Rabbani tahun ajaran 2025/2026', 1200, 630, NULL, NULL, NULL, 'Beasiswa Generasi Rabbani LAZ Darul Hikam untuk 48 siswa dhuafa berprestasi', NULL, 'index,follow', NULL, NULL, NULL, 'summary_large_image', 'id', 1, 4, '2025-06-29 03:00:00+00', 't', 0, 5, '2026-07-19 15:37:33.049361+00', '2026-07-19 22:31:49.902212+00', NULL, 1),
(4, 'modal-bergulir-surabaya-berdaya-mandiri', '87 Pedagang Kecil Surabaya Terima Modal Bergulir LAZ', '87 Pedagang Kecil Surabaya Terima Modal Bergulir Program Berdaya Mandiri', 'Omset 87 pedagang kecil peserta program Berdaya Mandiri LAZ Darul Hikam meningkat rata-rata 40% dalam tiga bulan.', '<h2>Memberdayakan Pelaku UMKM Dhuafa</h2>
...
<p>Program Berdaya Mandiri sedang dalam proses ekspansi ke Semarang dan Yogyakarta. Dukung program ini agar lebih banyak keluarga dhuafa bisa mandiri secara ekonomi.</p>', 'published', 'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750', 'Para peserta program Berdaya Mandiri LAZ berfoto di depan stand UMKM mereka', 'Penyerahan modal bergulir Program Berdaya Mandiri LAZ Darul Hikam, Surabaya — Juni 2025', 1200, 630, NULL, NULL, NULL, 'Program Berdaya Mandiri LAZ Darul Hikam: modal bergulir untuk pedagang kecil Surabaya', NULL, 'index,follow', NULL, NULL, NULL, 'summary_large_image', 'id', 4, 4, '2025-06-20 04:00:00+00', 'f', 0, 5, '2026-07-19 15:37:33.049361+00', '2026-07-19 22:31:49.902212+00', NULL, 1),
(5, 'klinik-keliling-papua-juni-2025', 'Klinik Keliling LAZ Layani 2.300 Warga di 6 Desa Papua', 'Klinik Keliling LAZ Darul Hikam Layani 2.300 Warga Dhuafa di 6 Desa Papua', 'Tim medis LAZ bersama dokter relawan memberikan layanan kesehatan gratis termasuk pemeriksaan umum, gigi, dan obat-obatan di Papua.', '<h2>Menjangkau yang Tak Terjangkau</h2>
...
<p>Klinik Keliling LAZ berjalan rutin setiap kuartal ke daerah 3T. Bantu kami melanjutkan misi ini dengan berdonasi ke program Layanan Kesehatan Gratis.</p>', 'published', 'https://images.pexels.com/photos/3259624/pexels-photo-3259624.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750', 'Antrian warga Papua menunggu pemeriksaan di klinik keliling LAZ Darul Hikam', 'Klinik Keliling LAZ Darul Hikam di Papua Tengah — Juni 2025', 1200, 630, NULL, NULL, NULL, 'Klinik keliling LAZ Darul Hikam layani 2.300 warga dhuafa di 6 desa Papua Tengah', NULL, 'index,follow', NULL, NULL, NULL, 'summary_large_image', 'id', 2, 4, '2025-06-10 01:00:00+00', 'f', 0, 5, '2026-07-19 15:37:33.049361+00', '2026-07-19 22:31:49.902212+00', NULL, 1),
(6, 'rumah-tahfidz-cetak-hafidz-baru', 'Rumah Tahfidz LAZ Cetak 12 Hafidz Quran dari Keluarga Dhuafa', 'Rumah Tahfidz LAZ Darul Hikam Cetak 12 Hafidz Quran Baru dari Kalangan Dhuafa', 'Program tahfidz intensif 2 tahun LAZ Darul Hikam mencetak 12 hafidz Quran dari keluarga dhuafa, siap mengajar di pesantren.', '<h2>Mencetak Penjaga Kalamullah dari Keluarga Dhuafa</h2>
...
<p>Ke-12 hafidz baru akan menjadi pengajar di majelis ilmu dan pesantren mitra LAZ. Dengan wakaf Anda, satu hafidz lagi bisa lahir. <strong>Titipkan wakaf untuk program Dakwah & Pembinaan Umat.</strong></p>', 'published', 'https://images.pexels.com/photos/7249337/pexels-photo-7249337.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750', 'Momen wisuda angkatan ke-4 Rumah Tahfidz Darul Hikmah dengan 12 hafidz baru', 'Wisuda Hafidz Angkatan ke-4 Rumah Tahfidz Darul Hikmah, Cimahi — 31 Mei 2025', 1200, 630, NULL, NULL, NULL, 'Wisuda 12 hafidz Quran Rumah Tahfidz LAZ Darul Hikam angkatan ke-4 dari keluarga dhuafa', NULL, 'index,follow', NULL, NULL, NULL, 'summary_large_image', 'id', 5, 4, '2025-06-02 02:00:00+00', 'f', 0, 4, '2026-07-19 15:37:33.049361+00', '2026-07-19 22:31:49.902212+00', NULL, 1);
...
INSERT INTO "public"."web_article_tags" ("article_id", "tag_id") VALUES
(1, 2),
(1, 3),
(2, 7),
(2, 10),
...
INSERT INTO "public"."web_tags" ("id", "name", "slug", "created_at") VALUES
(1, 'Beasiswa', 'beasiswa', '2026-07-19 15:37:33.049361+00'),
(2, 'NTT', 'ntt', '2026-07-19 15:37:33.049361+00'),
(3, 'Tanggap Bencana', 'tanggap-bencana', '2026-07-19 15:37:33.049361+00'),
(4, 'Kesehatan', 'kesehatan', '2026-07-19 15:37:33.049361+00'),
(5, 'Ekonomi', 'ekonomi', '2026-07-19 15:37:33.049361+00'),
(6, 'Dakwah', 'dakwah', '2026-07-19 15:37:33.049361+00'),
(7, 'Kalimantan', 'kalimantan', '2026-07-19 15:37:33.049361+00'),
(8, 'Papua', 'papua', '2026-07-19 15:37:33.049361+00'),
(9, 'Tahfidz', 'tahfidz', '2026-07-19 15:37:33.049361+00'),
(10, 'Wakaf', 'wakaf', '2026-07-19 15:37:33.049361+00');

INSERT INTO "public"."web_testimonials" ("id", "person_name", "person_role", "person_type", "initials", "quote", "avatar_url", "program_id", "is_active", "display_order", "created_at", "updated_at") VALUES
(1, 'Ahmad Rizaldi', 'Pengusaha, Jakarta', 'muzakki', 'AR ', 'Sudah 3 tahun berzakat di LAZ Darul Hikam. Laporannya detail, ada foto dan video penyalurannya. Sangat senang bisa tahu zakat saya sampai ke tangan yang tepat.', NULL, NULL, 't', 1, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(2, 'Suwardi', 'Petani, Banyumas', 'mustahiq', 'SW ', 'Berkat beasiswa dari LAZ Darul Hikam, anak saya bisa melanjutkan sekolah. Tadinya hampir putus asa. Sekarang dia kelas 11 dan bercita-cita jadi dokter.', NULL, 1, 't', 2, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(3, 'Fatimah Hasan', 'HR Manager, Bandung', 'muzakki', 'FH ', 'Kantor kami rutin berkolaborasi untuk CSR. Tim LAZ sangat responsif dan laporannya lengkap untuk ditunjukkan ke manajemen pusat.', NULL, NULL, 't', 3, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(4, 'Nur Khasanah', 'Pedagang, Semarang', 'mustahiq', 'NK ', 'Modal bergulir dari LAZ mengubah hidup saya. Warung kecil saya kini berkembang dan saya sudah bisa mencicil rumah sendiri.', NULL, 4, 't', 4, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00');

INSERT INTO "public"."web_impact_metrics" ("id", "metric_key", "label", "value", "suffix", "display_order", "is_active", "updated_by", "updated_at") VALUES
(1, 'total_funds_distributed_m', 'Dana Tersalurkan (Rp)', 47.00, 'M+', 1, 't', 2, '2026-07-19 15:37:33.049361+00'),
(2, 'total_beneficiaries_k', 'Penerima Manfaat', 127.00, 'rb+', 2, 't', 2, '2026-07-19 15:37:33.049361+00'),
(3, 'provinces_reached', 'Provinsi Terjangkau', 28.00, '', 3, 't', 2, '2026-07-19 15:37:33.049361+00'),
(4, 'active_volunteers', 'Relawan Aktif', 1200.00, '+', 4, 't', 2, '2026-07-19 15:37:33.049361+00');

INSERT INTO "public"."web_financial_reports" ("id", "title", "report_type", "period_label", "period_year", "period_quarter", "audit_status", "file_url", "file_size_kb", "download_count", "is_published", "uploaded_by", "published_at", "created_at", "updated_at") VALUES
(1, 'Laporan Keuangan Tahunan 2024', 'annual', 'Tahunan 2024', 2024, NULL, 'kap_audited', '/reports/laz-annual-2024.pdf', 2840, 0, 't', 2, '2025-02-28 17:00:00+00', '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(2, 'Laporan Triwulan Q2 2025', 'quarterly', 'Q2 2025', 2025, 2, 'internally_reviewed', '/reports/laz-q2-2025.pdf', 1120, 0, 't', 2, '2025-07-09 17:00:00+00', '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(3, 'Laporan Triwulan Q1 2025', 'quarterly', 'Q1 2025', 2025, 1, 'kap_audited', '/reports/laz-q1-2025.pdf', 1080, 0, 't', 2, '2025-04-14 17:00:00+00', '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(4, 'Laporan Keuangan Tahunan 2023', 'annual', 'Tahunan 2023', 2023, NULL, 'kap_audited', '/reports/laz-annual-2023.pdf', 2650, 0, 't', 2, '2024-03-09 17:00:00+00', '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00');

INSERT INTO "public"."web_faqs" ("id", "question", "answer", "category", "is_active", "display_order", "created_by", "updated_by", "created_at", "updated_at") VALUES
(1, 'Apakah LAZ Darul Hikam sudah berizin resmi?', 'Ya, LAZ Darul Hikam mendapat izin resmi dari Kementerian Agama RI melalui SK Nomor 792 Tahun 2020 dan terdaftar sebagai anggota BAZNAS.', 'general', 't', 1, 5, NULL, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(2, 'Bagaimana cara memastikan donasi saya sudah diterima?', 'Anda akan menerima konfirmasi via email dan SMS setelah donasi dikonfirmasi. Status donasi juga bisa dicek melalui dashboard transparansi kami.', 'donation', 't', 2, 5, NULL, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(3, 'Apakah ada biaya administrasi dari donasi?', 'Tidak ada potongan biaya administrasi. 100% dana yang Anda titipkan disalurkan sesuai peruntukannya; biaya operasional LAZ ditanggung dari pos amil.', 'donation', 't', 3, 5, NULL, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(4, 'Bisakah saya berdonasi secara anonim?', 'Tentu bisa. Pilih opsi Donasi Anonim pada form donasi kami. Nama Anda tidak akan dicantumkan dalam laporan publik.', 'donation', 't', 4, 5, NULL, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(5, 'Berapa minimal donasi yang bisa saya berikan?', 'Tidak ada batas minimal donasi. Sekecil apapun yang Anda berikan, InsyaAllah akan berdampak bagi sesama.', 'general', 't', 5, 5, NULL, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00');

INSERT INTO "public"."web_fund_allocations" ("id", "program_id", "period_year", "period_month", "allocated_amount", "disbursed_amount", "beneficiary_count", "notes", "created_by", "created_at", "updated_at") VALUES
(1, 1, 2025, 6, 28500000.00, 28500000.00, 48, NULL, 2, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(2, 2, 2025, 6, 15000000.00, 14800000.00, 230, NULL, 2, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(3, 3, 2025, 6, 52000000.00, 52000000.00, 1200, NULL, 2, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(4, 4, 2025, 6, 9200000.00, 9200000.00, 87, NULL, 2, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(5, 5, 2025, 6, 18000000.00, 17500000.00, 120, NULL, 2, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(6, 1, 2025, 7, 30000000.00, 22000000.00, 38, NULL, 2, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(7, 3, 2025, 7, 40000000.00, 40000000.00, 890, NULL, 2, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00');

INSERT INTO "public"."web_partners" ("id", "name", "logo_url", "website_url", "partner_type", "is_active", "display_order", "created_at", "updated_at") VALUES
(1, 'Bank Syariah Indonesia', NULL, NULL, 'corporate', 't', 1, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(2, 'BAZNAS Pusat', NULL, NULL, 'government', 't', 2, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(3, 'Kemensos RI', NULL, NULL, 'government', 't', 3, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(4, 'Forum Zakat (FOZ)', NULL, NULL, 'ngo', 't', 4, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(5, 'MUI Pusat', NULL, NULL, 'government', 't', 5, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(6, 'Pesantren Darul Hikam', NULL, NULL, 'academic', 't', 6, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(7, 'Univ. Al-Azhar Indonesia', NULL, NULL, 'academic', 't', 7, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(8, 'PT Pertamina (Persero)', NULL, NULL, 'corporate', 't', 8, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(9, 'RS Islam Jakarta', NULL, NULL, 'ngo', 't', 9, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(10, 'Komunitas Sahabat Yatim', NULL, NULL, 'ngo', 't', 10, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00');

INSERT INTO "public"."web_team_members" ("id", "name", "title", "department", "initials", "avatar_url", "bio", "accent_color", "is_active", "display_order", "created_at", "updated_at") VALUES
(1, 'Ust. Ahmad Habib, Lc.', 'Direktur Utama', 'Eksekutif', 'AH ', NULL, NULL, '#3268C3', 't', 1, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(2, 'Sari Ramadhani, S.E.', 'Direktur Keuangan', 'Keuangan', 'SR ', NULL, NULL, '#1a6b3c', 't', 2, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(3, 'M. Fauzi, S.Kom.', 'Direktur Program', 'Program', 'MF ', NULL, NULL, '#c9892a', 't', 3, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00'),
(4, 'Rini Nurhayati, S.H.', 'Direktur Legal & Compliance', 'Legal', 'RN ', NULL, NULL, '#5585d4', 't', 4, '2026-07-19 15:37:33.049361+00', '2026-07-19 15:37:33.049361+00');

CREATE VIEW "public"."v_article_seo" AS ;
...
ALTER TABLE "public"."web_articles" ADD FOREIGN KEY ("author_id") REFERENCES "public"."admins"("id");
ALTER TABLE "public"."web_articles" ADD FOREIGN KEY ("program_id") REFERENCES "public"."campaigns"("id") ON DELETE SET NULL;
ALTER TABLE "public"."web_articles" ADD FOREIGN KEY ("category_id") REFERENCES "public"."web_article_categories"("id") ON DELETE SET NULL;


-- Indices
CREATE UNIQUE INDEX web_articles_slug_key ON public.web_articles USING btree (slug);
CREATE INDEX idx_art_status ON public.web_articles USING btree (status);
CREATE INDEX idx_art_published_at ON public.web_articles USING btree (published_at DESC);
CREATE INDEX idx_art_program_id ON public.web_articles USING btree (program_id);
CREATE INDEX idx_art_slug ON public.web_articles USING btree (slug);
CREATE INDEX idx_art_deleted ON public.web_articles USING btree (deleted_at) WHERE (deleted_at IS NULL);
CREATE INDEX idx_art_featured ON public.web_articles USING btree (published_at DESC) WHERE ((is_featured = true) AND ((status)::text = 'published'::text));
CREATE INDEX idx_art_noindex ON public.web_articles USING btree (id) WHERE ((robots_directive)::text ~~ 'noindex%'::text);
CREATE INDEX idx_art_fts ON public.web_articles USING gin (to_tsvector('indonesian'::regconfig, (((title)::text || ' '::text) || (COALESCE(excerpt, ''::character varying))::text)));


-- Indices
CREATE UNIQUE INDEX admins_email_key ON public.admins USING btree (email);
ALTER TABLE "public"."web_article_tags" ADD FOREIGN KEY ("article_id") REFERENCES "public"."web_articles"("id") ON DELETE CASCADE;
ALTER TABLE "public"."web_article_tags" ADD FOREIGN KEY ("tag_id") REFERENCES "public"."web_tags"("id") ON DELETE CASCADE;


-- Indices
CREATE INDEX idx_article_tags_tag_id ON public.web_article_tags USING btree (tag_id);


-- Indices
CREATE UNIQUE INDEX web_tags_name_key ON public.web_tags USING btree (name);
CREATE UNIQUE INDEX web_tags_slug_key ON public.web_tags USING btree (slug);
CREATE INDEX idx_tags_slug ON public.web_tags USING btree (slug);
ALTER TABLE "public"."web_testimonials" ADD FOREIGN KEY ("program_id") REFERENCES "public"."campaigns"("id") ON DELETE SET NULL;


-- Indices
CREATE INDEX idx_testimonials_type ON public.web_testimonials USING btree (person_type);
CREATE INDEX idx_testimonials_is_active ON public.web_testimonials USING btree (is_active) WHERE (is_active = true);
CREATE INDEX idx_testimonials_display_order ON public.web_testimonials USING btree (display_order);
ALTER TABLE "public"."web_impact_metrics" ADD FOREIGN KEY ("updated_by") REFERENCES "public"."admins"("id") ON DELETE SET NULL;


-- Indices
CREATE INDEX idx_impact_metrics_order ON public.web_impact_metrics USING btree (display_order);
CREATE UNIQUE INDEX web_impact_metrics_metric_key_key ON public.web_impact_metrics USING btree (metric_key);
CREATE INDEX idx_impact_metrics_active ON public.web_impact_metrics USING btree (is_active) WHERE (is_active = true);
ALTER TABLE "public"."web_financial_reports" ADD FOREIGN KEY ("uploaded_by") REFERENCES "public"."admins"("id");


-- Indices
CREATE INDEX idx_reports_year ON public.web_financial_reports USING btree (period_year DESC);
CREATE INDEX idx_reports_type ON public.web_financial_reports USING btree (report_type);
CREATE INDEX idx_reports_is_published ON public.web_financial_reports USING btree (is_published) WHERE (is_published = true);
ALTER TABLE "public"."web_faqs" ADD FOREIGN KEY ("created_by") REFERENCES "public"."admins"("id") ON DELETE SET NULL;
ALTER TABLE "public"."web_faqs" ADD FOREIGN KEY ("updated_by") REFERENCES "public"."admins"("id") ON DELETE SET NULL;


-- Indices
CREATE INDEX idx_faqs_active ON public.web_faqs USING btree (is_active) WHERE (is_active = true);
CREATE INDEX idx_faqs_category ON public.web_faqs USING btree (category);
CREATE INDEX idx_faqs_order ON public.web_faqs USING btree (display_order);
ALTER TABLE "public"."web_fund_allocations" ADD FOREIGN KEY ("program_id") REFERENCES "public"."campaigns"("id") ON DELETE CASCADE;
ALTER TABLE "public"."web_fund_allocations" ADD FOREIGN KEY ("created_by") REFERENCES "public"."admins"("id") ON DELETE SET NULL;


-- Indices
CREATE UNIQUE INDEX web_fund_allocations_program_id_period_year_period_month_key ON public.web_fund_allocations USING btree (program_id, period_year, period_month);
CREATE INDEX idx_alloc_program_id ON public.web_fund_allocations USING btree (program_id);
CREATE INDEX idx_alloc_period ON public.web_fund_allocations USING btree (period_year DESC, period_month DESC);
ALTER TABLE "public"."web_cms_audit_log" ADD FOREIGN KEY ("user_id") REFERENCES "public"."admins"("id") ON DELETE CASCADE;


-- Indices
CREATE INDEX idx_audit_user_id ON public.web_cms_audit_log USING btree (user_id);
CREATE INDEX idx_audit_entity ON public.web_cms_audit_log USING btree (entity_type, entity_id);
CREATE INDEX idx_audit_created_at ON public.web_cms_audit_log USING btree (created_at DESC);
CREATE INDEX idx_audit_recent ON public.web_cms_audit_log USING btree (created_at DESC);


-- Indices
CREATE INDEX idx_partners_active ON public.web_partners USING btree (is_active) WHERE (is_active = true);
CREATE INDEX idx_partners_order ON public.web_partners USING btree (display_order);


-- Indices
CREATE INDEX idx_team_active ON public.web_team_members USING btree (is_active) WHERE (is_active = true);
CREATE INDEX idx_team_order ON public.web_team_members USING btree (display_order);


-- Indices
CREATE INDEX idx_bank_accounts_active ON public.web_bank_accounts USING btree (is_active) WHERE (is_active = true);


-- Indices
CREATE UNIQUE INDEX web_article_categories_slug_key ON public.web_article_categories USING btree (slug);
